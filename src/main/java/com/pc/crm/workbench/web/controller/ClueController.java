...
import com.pc.crm.workbench.service.ClueService;
import com.pc.crm.workbench.service.impl.ActivityServiceImpl;
import com.pc.crm.workbench.service.impl.ClueServiceImpl;
...
public class ClueController extends HttpServlet {
    ...
    private void getActivityListByName(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("通过活动名字模糊查询活动列表");
    ...
    private void getActivityListByNameAndNotByClueId(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("进入到通过活动名称模糊查询关联查询操作");
        String aname = request.getParameter("aname");
        String clueId = request.getParameter("clueId");
    ...
    private void detail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("通过id查询线索操作,跳转到详细信息页");
        String id = request.getParameter("id");
        ClueService cs = (ClueService) ServiceFactory.getService(new ClueServiceImpl());
